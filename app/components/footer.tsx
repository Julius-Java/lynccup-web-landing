				...
				<div className="space-y-8 lg:space-y-0 lg:grid lg:grid-cols-3 lg:place-items-center">
                                        <div className="space-y-4">
                                                ...
                                                <p className="text-sm max-w-[90%] lg:max-w-[70%]">
                                                        Lynccup is a solution that’s revolutionizing event
                                                        discovery and ticketing for event organizers and
                                                        attendees all over the world.
                                                </p>
                                        </div>
                                        <div className="space-y-4">
                                        ...
                                        <div className="space-y-4">
                                                <h4 className="font-ibm_sans_bold font-[600]">Follow us</h4>
                                                <div className="space-y-3 text-sm">
                                                        <a href="#" className="flex items-center gap-x-2 max-w-max">
                                ...
                                <p className="text-sm text-center">Copyright &copy; {new Date().getFullYear()}. Lynccup. All rights reserved.</p>
			</section>
		</footer>
	);
}
